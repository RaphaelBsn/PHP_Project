         ...
         <form method="POST" action="inscription.php">
            <table>
               <tr>
                  ...
                  <td>
                     <input type="text" placeholder="Votre nom" id="nom" name="nom" value="<?php if(isset($nom)) { echo $nom; } ?>" required />
                  </td>
               </tr>
                <tr>
                  <td align="right">
                  ...
                  <td>
                     <input type="text" placeholder="Votre prenom" id="prenom" name="prenom" value="<?php if(isset($prenom)) { echo $prenom; } ?>" required />
                  </td>
               </tr>
               <tr>
                  <td align="right">
